...
fn net_predefined(name: &str) -> bool {
...
async fn network_ips(req: &Req) -> Result<Value> {
...
async fn set_network_ip(req: &Req) -> Result<Value> {
...
async fn rename_network(req: &Req) -> Result<Value> {
    use bollard::models::{EndpointIpamConfig, EndpointSettings};
