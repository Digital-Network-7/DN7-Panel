...
const I18N = {
  en: {
    ...
    'my.ext_port': 'External port (maps 3306)', 'my.expose': 'Map port externally', 'my.engine': 'Engine', 'my.version': 'Version', 'my.ext_port_label': 'External port (maps 3306)', 'my.cred_note': 'A “root” admin account is created by default — you can change the name and password. Create multiple databases inside the instance.',
  ...
  'zh-CN': {
    ...
    'my.ext_port': '对外端口（映射 3306）', 'my.expose': '对外映射端口', 'my.engine': '引擎', 'my.version': '版本', 'my.ext_port_label': '外部端口（映射 3306）', 'my.cred_note': '默认创建 root 管理员账号，可自定义用户名与密码；可在实例内创建多个数据库。',
  ...
  'zh-TW': {
    ...
    'my.ext_port': '對外連接埠（對應 3306）', 'my.expose': '對外對應連接埠', 'my.engine': '引擎', 'my.version': '版本', 'my.ext_port_label': '對外連接埠（對應 3306）', 'my.cred_note': '預設建立 root 管理員帳號，可自訂使用者名稱與密碼；可在實例內建立多個資料庫。',
  ...
  ja: {
    ...
    'my.ext_port': '外部ポート（3306 にマッピング）', 'my.expose': 'ポートを外部公開', 'my.engine': 'エンジン', 'my.version': 'バージョン', 'my.ext_port_label': '外部ポート（3306 にマッピング）', 'my.cred_note': '既定で root 管理者アカウントを作成します（名前とパスワードは変更可）。インスタンス内に複数のデータベースを作成できます。',
