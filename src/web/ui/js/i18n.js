...
const I18N = {
  en: {
    ...
    'acct.profile': 'Edit profile', 'acct.password': 'Change password', 'acct.twofa': 'Two-factor auth', 'acct.avatar': 'Avatar', 'acct.full_name': 'Full name', 'acct.nickname': 'Nickname',
  ...
  'zh-CN': {
    ...
    'acct.profile': '编辑资料', 'acct.password': '修改密码', 'acct.twofa': '2FA 验证', 'acct.avatar': '头像', 'acct.full_name': '全名', 'acct.nickname': '昵称',
    ...
    'um.title': '用户', 'um.add': '新增用户', 'um.account': '账号', 'um.account_ph': '小写字母/数字/_/-', 'um.role': '权限', 'um.super': '所有者', 'um.admin': '管理员', 'um.user': '普通用户', 'um.admin_sudo': '管理员（sudo）', 'um.note': '每个用户对应一个系统账号；管理员拥有 sudo。所有权限均基于其系统用户。', 'um.create_note': '会同步创建对应的系统用户（管理员将加入 sudo 组）。', 'um.confirm_del': '删除用户「{name}」？同时会删除其系统账号及家目录。', 'um.creating': '创建中…', 'um.created': '用户已创建',
    ...
    'err.settings.port_range': '端口需为 1-65535', 'err.settings.pw_format': '密码格式错误', 'err.settings.username_format': '账号需为 2-32 位字母/数字/_/-', 'err.settings.username_reserved': '“admin”为保留账号，请换一个账号名', 'err.settings.pw_is_default': '请设置一个与默认密码不同的密码',
  ...
  'zh-TW': {
    ...
    'acct.profile': '編輯資料', 'acct.password': '修改密碼', 'acct.twofa': '2FA 驗證', 'acct.avatar': '頭像', 'acct.full_name': '全名', 'acct.nickname': '暱稱',
    ...
    'err.settings.port_range': '連接埠需為 1-65535', 'err.settings.pw_format': '密碼格式錯誤', 'err.settings.username_format': '帳號需為 2-32 位字母/數字/_/-', 'err.settings.username_reserved': '“admin”為保留帳號，請換一個帳號名', 'err.settings.pw_is_default': '請設定一個與預設密碼不同的密碼',
  ...
  ja: {
    ...
    'acct.profile': 'プロフィール編集', 'acct.password': 'パスワード変更', 'acct.twofa': '二要素認証', 'acct.avatar': 'アバター', 'acct.full_name': '氏名', 'acct.nickname': 'ニックネーム',
    ...
    'err.settings.port_range': 'ポートは1〜65535である必要があります', 'err.settings.pw_format': 'パスワードの形式が不正です', 'err.settings.username_format': 'アカウントは2〜32文字（英数字・_・-）', 'err.settings.username_reserved': '「admin」は予約済みです。別のアカウント名を選んでください', 'err.settings.pw_is_default': 'デフォルトと異なるパスワードを設定してください',
