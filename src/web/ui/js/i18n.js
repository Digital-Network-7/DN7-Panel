...
const I18N = {
  en: {
    ...
    'err.nginx.cert_not_found': 'Certificate not found', 'err.nginx.duplicate_domain': 'Another site already uses this domain — remove or edit that site first', 'err.mysql.instance_not_found': 'Instance not found (it may have been deleted)', 'err.mysql.missing_instance_id': 'Missing instance id', 'err.mysql.port_range': 'Port must be 1-65535',
  ...
  'zh-CN': {
    ...
    'err.nginx.cert_not_found': '证书不存在', 'err.nginx.duplicate_domain': '已有其他站点使用该域名，请先删除或编辑那个站点', 'err.mysql.instance_not_found': '找不到该实例（可能已删除）', 'err.mysql.missing_instance_id': '缺少实例 id', 'err.mysql.port_range': '端口需为 1-65535',
  ...
  'zh-TW': {
    ...
    'err.nginx.cert_not_found': '憑證不存在', 'err.nginx.duplicate_domain': '已有其他站點使用該網域，請先刪除或編輯那個站點', 'err.mysql.instance_not_found': '找不到該實例（可能已刪除）', 'err.mysql.missing_instance_id': '缺少實例 id', 'err.mysql.port_range': '連接埠需為 1-65535',
  ...
  ja: {
    ...
    'err.nginx.cert_not_found': '証明書が存在しません', 'err.nginx.duplicate_domain': 'このドメインは別のサイトで使用中です。先にそのサイトを削除または編集してください', 'err.mysql.instance_not_found': 'インスタンスが見つかりません（削除された可能性があります）', 'err.mysql.missing_instance_id': 'インスタンス id がありません', 'err.mysql.port_range': 'ポートは1〜65535',
