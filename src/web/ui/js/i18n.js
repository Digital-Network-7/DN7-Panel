...
const I18N = {
  en: {
    ...
    'tab.website': 'Website', 'tab.databases': 'Databases', 'tab.users': 'Users', 'tab.logs': 'Logs',
  ...
  'zh-CN': {
    ...
    'tab.website': '网站', 'tab.databases': '数据库', 'tab.users': '用户', 'tab.logs': '日志',
  ...
  'zh-TW': {
    ...
    'tab.website': '網站', 'tab.databases': '資料庫', 'tab.users': '使用者', 'tab.logs': '日誌',
  ...
  ja: {
    ...
    'tab.website': 'ウェブサイト', 'tab.databases': 'データベース', 'tab.users': 'ユーザー', 'tab.logs': 'ログ',
