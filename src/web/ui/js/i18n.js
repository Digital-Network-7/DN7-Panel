...
const I18N = {
  en: {
    ...
    'err.users.bad_username': 'Account must be lowercase letters/digits/_/- starting with a letter', 'err.users.bad_role': 'Invalid role', 'err.users.exists': 'That account already exists', 'err.users.not_found': 'User not found', 'err.users.no_sudo_group': 'No sudo/wheel group on this system',
  ...
  'zh-CN': {
    ...
    'err.users.bad_username': '账号需为小写字母/数字/_/-，且以字母开头', 'err.users.bad_role': '权限无效', 'err.users.exists': '该账号已存在', 'err.users.not_found': '用户不存在', 'err.users.no_sudo_group': '系统中没有 sudo/wheel 组',
  ...
  'zh-TW': {
    ...
    'err.users.bad_username': '帳號需為小寫字母/數字/_/-，且以字母開頭', 'err.users.bad_role': '權限無效', 'err.users.exists': '該帳號已存在', 'err.users.not_found': '使用者不存在', 'err.users.no_sudo_group': '系統中沒有 sudo/wheel 群組',
  ...
  ja: {
    ...
    'err.users.bad_username': 'アカウントは英小文字/数字/_/- で、英字で始める必要があります', 'err.users.bad_role': '権限が無効です', 'err.users.exists': 'そのアカウントは既に存在します', 'err.users.not_found': 'ユーザーが見つかりません', 'err.users.no_sudo_group': 'システムに sudo/wheel グループがありません',
